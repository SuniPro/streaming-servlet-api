...
@Configuration
@EnableR2dbcRepositories(basePackages = "com.taekang.streamingreactiveapi.repository.leagueInfo")
public class R2dbcEntityTemplateConfig {
  ...
  @Bean
  public DatabaseClient leagueInfoDatabaseClient(
      @Qualifier("leagueInfoConnectionFactory") ConnectionFactory connectionFactory) {
    return DatabaseClient.create(connectionFactory);
  }

  @Bean
  public ReactiveTransactionManager leagueInfoTransactionManager(
      @Qualifier("leagueInfoConnectionFactory") ConnectionFactory connectionFactory) {
